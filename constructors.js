...
User.prototype.removeSavedPost = function(postID) {
  const matchPost = this.savedPosts.findIndex(post => post.id === postID)
  return this.savedPosts.splice(matchPost,1)
...
// Code here
User.prototype.changePostRating = function(iD, newwRating) {
  const matchID = this.savedPosts.findIndex(post => post.id === iD)
  return this.savedPosts[matchID] = {id: this.savedPosts[matchID].id, title: this.savedPosts[matchID].title, rating: newwRating}
}